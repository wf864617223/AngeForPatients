 ...
 */
public class OrderingNewAdapter extends RecyclerView.Adapter<OrderingNewAdapter.MyViewHolder> {
    List<PayOrderedBean.ResultBean.ListBean> list;
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private Context mContext;
    private LayoutInflater layoutInflater;

    public OrderingNewAdapter(List<PayOrderedBean.ResultBean.ListBean> list, Context mContext) {
        this.list = list;
