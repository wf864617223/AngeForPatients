...
import com.hb.findim.FindHomeActivity;
...
//                    Intent intent = new Intent(getActivity(), FindHomeActivity.class);
//                    startActivity(intent);
                    Bundle bundle = getArguments();
                    String userId = bundle.getString("userId");
                    try {
                        EMClient.getInstance().groupManager().blockGroupMessage(userId);
                        Toast.makeText(getContext(), "已屏蔽群消息", Toast.LENGTH_SHORT).show();
